...
class Inception3(nn.Module):
    ...
    def __init__(self, num_classes=1000, args=None, threshold=None, transform_input=False):
        ...
        # self.center_feat_bank = torch.randn((args.num_classes, 768))
        # self.center_feat_bank.requires_grad=False
        self.center_feat_bank = nn.Parameter(torch.randn((args.num_classes, 768)), requires_grad=False)
    ...
    def center_aux_classifier(self, gt_labels, center_feats):
        batch_center_feats = self.fuse_center_vec(gt_labels, center_feats)
        aux_logits = self.aux_cls(batch_center_feats)
        return aux_logits
